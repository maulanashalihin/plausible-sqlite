    ...
    cond do
      ...
      true ->
        ...
        |> render("stats.html",
          ...
          native_stats_start_date: site.native_stats_start_at && NaiveDateTime.to_date(site.native_stats_start_at),
    ...
    cond do
      ...
      not Teams.locked?(shared_link.site.team) ->
        ...
        |> render("stats.html",
          ...
          stats_start_date: stats_start_date,
          native_stats_start_date: shared_link.site.native_stats_start_at && NaiveDateTime.to_date(shared_link.site.native_stats_start_at),
